...
<div class="wrap">
    ...
    <div class="container layout-main">
        <div class="row">
            <div class="col-sm-2">
                <?= Html::img('@web/files/conf3/logo_conf3.png', ['class' => 'logo-main-position', 'style' => 'width: 200px;']) ?>
            </div>
            <div class="col-sm-10 ">
                <h3 class="text-center">
                    <div>Межвузовская биологическая универсиада</div>
                    <br>
                </h3>
                <h3 class="text-center">
                    <div>Россия, г. Вологда</div>
                    <div>ФГБУН ВолНЦ РАН</div>
                    <div>16 ноября 2020 года</div>
                </h3>
            </div>
        </div>
        <?php
